...
class CreatePostInterActor : CreatePostContract.InterActor, ProgressRequestBody.UploadCallbacks {
    override fun createPost(
        ...
        when {
            !images.isNullOrEmpty() && videos.isNullOrEmpty() -> {
                ...
                RetroWeb.client.create(ServiceApi::class.java).createPostWithMedia(url,auth, postId,
            ...
            else -> RetroWeb.client.create(ServiceApi::class.java).createPost(url,auth, postId, postType,
